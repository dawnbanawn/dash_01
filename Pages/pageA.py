        ...
        dbc.Card( # This adds some styling, padding
                    dbc.CardBody([
                        html.Div(children = [
                           ...
                           html.Div("In Databricks I joined the data, made some EDA, found out that some regions show sales monthly and not daily, so I grouped and summed the sales monthly, trained SARIMAX forecast models, looping the training for each region, and made predictions with them."),
                            html.Div("",style={"marginBottom": "20px"}),
                           ...
                           html.Div("With a python script and two SQL queries I fetched both original and predicted data to this dash app, as local .csv files."),
                            html.Div("",style={"marginBottom": "20px"}),
